...
- Solution URL: (https://github.com/nicobreins/Rest-Countries-API)
- Live Site URL: (https://nicobreins.github.io/Rest-Countries-API/)
...
- Https requests in ES6
- Imporving page performance 
